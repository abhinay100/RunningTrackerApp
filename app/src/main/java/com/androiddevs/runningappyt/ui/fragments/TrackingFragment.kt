...
class TrackingFragment: Fragment(R.layout.fragment_tracking) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync {
            map = it
            //this is called when fragment is created hence we need this function
            addAllPolylines()
        }
    ...
    private fun toggleRun() {
        if(isTracking) {
            ...
            sendCommandToServicc(ACTION_PAUSE_SERVICE)
        } else {
            sendCommandToServicc(ACTION_START_OR_RESUME_SERVICE)
        }
    }
    ...
    private fun showTrackingDialog() {
    ...
    private fun stopRun() {
        sendCommandToServicc(ACTION_STOP_SERVICE)
    ...
    private fun addLatestPolyline() {
        if(pathPoints.isNotEmpty() && pathPoints.last().size > 1) {
            //need to get the second last line
    ...
    private fun sendCommandToServicc(action: String) =
